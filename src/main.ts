...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['http://127.0.0.1:5500','http://127.0.0.1:8080', 'http://localhost:4200', 'http://localhost:3001', 'https://sweet-sunburst-77e346.netlify.app/'], // Allow requests only from this origin
